...
function standInTheRanks(world) {
  ...
  army.members.forEach((id, slot) => {
    ...
    // Nor anybody a fight has placed (sim/bexar-fight.mjs): a man who went into San Antonio is in the town, not at the mill.
    if (Object.values(world.battles || {}).some(battle => battle.participants?.[id]?.placed)) return;
