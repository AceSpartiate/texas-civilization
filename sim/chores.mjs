...
export function choreAvailability(world, household, entity, choreId, logsOut = null) {
  ...
  if (chore.where === 'home' && entity.location.siteId !== household.homeSiteId && !chore.alsoFrom?.includes(entity.location.siteId)) return { can: false, why: `${entity.name} is not at home.` };
