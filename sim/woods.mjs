...
export const KINDS = Object.freeze({
  ...
  'live-oak': kind('live oak', [0, 1, 1], 'sill', 1.5, 'oak-spreading'),
  ...
  elm: kind('elm', [1, 2, 2], 'poor', 1, 'oak-broad'),
  ...
  cedar: kind('cedar', [1, 1, 2], 'sill', 0.8, 'sapling'),
  loblolly: kind('loblolly pine', [2, 3, 4], 'wall', 0.8, 'cottonwood'),
  shortleaf: kind('shortleaf pine', [2, 3, 3], 'wall', 0.8, 'cottonwood'),
  mesquite: kind('mesquite', [0, 0, 0], 'none', 0.6, 'scrub'),
});
