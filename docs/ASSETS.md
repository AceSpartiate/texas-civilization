...
Updated 2026-09-26. **103 transparent PNG atlases, 1,399 usable sprite frames, 493 validated clips.** These are reusable game assets with working animation playback, not completed later campaigns or authenticated historical portraits.
...
The named-person batch adds six 4×4 transparent sheets: `famous-crockett`, `famous-travis`, `famous-bowie`, `famous-emily-west`, `famous-santa-anna`, and `famous-houston`. Each has east, south and north walking clips plus eight scene poses. West travel mirrors east. Bowie has illness and cot poses; Travis has letter-writing and defense; Crockett has rifle actions; Emily has work, conversation and departure in an elegant yellow dress with an uncovered braided updo, chosen by the owner as a **Yellow Rose legend-inspired costume**; Santa Anna has general-uniform and plain-clothes capture poses; Houston has command and bandaged-ankle aftermath. Three companion sheets add animated Emily/Santa Anna picnic conversation and alarm poses, plus a tent, blanket, basket and jug. These are **artist interpretations**, not authenticated likenesses or documented clothing. San Jacinto now draws the owner-chosen picnic vignette from early afternoon through the first guns with a dashed `LATER STORY` label, and its capture parley selects Santa Anna's plain-clothes frame and Houston's injured seated frame. The other named figures remain available to the future historical-person staging system described in `docs/BATTLES.md` §2c; art registration alone does not add them to the world.

Three more named-character sheets add Seguín, Susanna Dickinson, and toddler Angelina Dickinson. Both adults have three directional walking clips; Seguín also has courier and dispatch poses, and Susanna has four paired poses with Angelina. Angelina has sitting, reaching, stepping and sleeping frames, with one short seated/reaching loop. The paired poses must not be layered with a second copy of Angelina. Seguín's two mounted frames are still key poses, not a complete horse walk. `scripts/art-deliveries/famous-alamo-survivors.mjs` records their prompts and image origins. These are ready for the future identity-aware itinerary and scene projection, but do not themselves place these people in the world.

Milam and Fannin each gain a distinct 4×4 sheet with directional walks and eight campaign poses in `scripts/art-deliveries/famous-bexar-goliad.mjs`. Milam's fall is non-graphic; Fannin's sheet shows his bandaged leg, surrender and imprisonment without staging his killing. The server must still place and reveal them at the historically appropriate moments.
