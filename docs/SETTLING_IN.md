...
| Claims registered | `HIST-GONZ-024` to `026` sourced as in §2 (rows written into `HISTORY.md` 2026-09-14, after an audit found them cited but unregistered); every number and the late-arrival premise under `FIC-GONZ-024`. |
