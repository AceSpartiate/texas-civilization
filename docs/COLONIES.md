...
| What does enlisting for land earn? | **Glory now, land at the end**: glory for enlisting, and the promised acres count as coin at a period land price at the final reckoning, only if the person is alive and still serving, or released with the promise kept (the victory releases them; being sent for forfeits it - amended 2026-09-16 after the whole-game run). |
