...
- `ceiling:` the columns move in straight lines between their dated places, and the dates between the settlements' days
  are placed; a column's road along the map's own ways, with the record's day-by-day marches, is the way out.
