...
- The staged fate of a family's person inside a deadly battle is not built (none is at stake at Gonzales). Built for Béxar: §7.2; Concepción and the Grass Fight use the same path: §8.
...
## 8. Concepción and the Grass Fight on the engine (2026-09-25, wave 2; not released)
