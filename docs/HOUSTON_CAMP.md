...
| The march east (owner 2026-09-18) | At 3 p.m. on April 14 (`houston-donohos`) the story says **"The army has left Groce's and is marching east on the road to Harrisburg. Tonight it is camped at Donoho's, a few miles on."** and the camp moves a night at a time along the road to Harrisburg: **Donoho's**; **McCarley's** on Spring Creek at 6 p.m. on the 15th (`houston-mccarleys`); **the fork at Roberts'** at noon on the 16th, the moment the men are asked which road (`which-road`); **Burnett's** on Cypress Creek at noon on the 17th, when the question closes (`which-road-close`); and opposite **Harrisburg** at noon on the 18th, as before. Each is a place on the map (kind `farmstead`) at its marker, named from the zoom a landing is. On the march there is no drilling - **"The army is on the march to Harrisburg. There is no day to drill."** - and the guard, the mess and the scouts go on. A class saved before these were places keeps the army at Bernardo until the 18th, marches it straight to Harrisburg as it always did, and is still told it left. The hours are the game's own. | Donoho's the 14th (Barker; its marker has the army there the 14th-15th), McCarley's the 15th (its marker); the markers put Roberts' and Burnett's on the 16th and Kemp & Kilman on the 17th, and the fork is held a day so the question is asked where the road forks (`HIST-TEX-088`); "a forced march of fifty-five miles" (Houston). |
