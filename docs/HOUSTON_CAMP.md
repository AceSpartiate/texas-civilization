...
| The march east (owner 2026-09-18; a forced march, owner 2026-09-19) | At 3 p.m. on April 14 (`houston-donohos`) the story says **"The army has left Groce's and is marching east on the road to Harrisburg. Tonight it is camped at Donoho's, a few miles on."** and the army marches a night at a time along the road to Harrisburg, **a forced march of ten hours a day** (`FORCED_MARCH_HOURS`, thirty miles on foot, against a family's seven). Each camp's moment is when it **sets out**, so that it arrives on the record's day: **Donoho's** that night; **McCarley's** on Spring Creek, set out at dawn on the 15th and there that evening; **the fork at Roberts'**, set out at dawn on the 16th and there before noon, when the men are asked which road; **Burnett's** on Cypress Creek, set out at 2 p.m. while the question is still open (the army took the right-hand road whatever was said) and there that night; **opposite Harrisburg**, set out at noon on the 17th and there the evening of the 18th; **Lynch's ferry**, set out at noon on the 19th and there the morning of the 20th. Each house is a place on the map (kind `farmstead`) at its marker, named from the zoom a landing is. On the march there is no drilling - **"The army is on the march to Harrisburg. There is no day to drill."** - and the guard, the mess and the scouts go on. A man who reaches a camp the army has already left follows it (`catchUpCamp`); one his family has sent for is left to go. A class saved before these were places keeps the army at Bernardo until it sets out for Harrisburg and marches it straight there, and is still told it left. The hours are the game's own. | Donoho's the 14th (Barker; its marker has the army there the 14th-15th), McCarley's the 15th, Roberts' and Burnett's the 16th (their markers; Kemp & Kilman put them on the 17th); "a forced march of fifty-five miles" and opposite Harrisburg the evening of the 18th (Houston) (`HIST-TEX-088`); Lynch's ferry the 20th (`HIST-TEX-067`). The forced march and the hours: `FIC-GONZ-064`. |
...
- `tests/camp.test.mjs` (8): the camp's work on a serving row and nobody else's, three days to steady, a fourth refused, one
  ...
  plantation"; the fork said at Roberts'. The march east (4): its camps and the milestones at one moment each; the army a
  night at each house in order, never by San Felipe, no drilling on the march and the guard open, opposite Harrisburg not
  before the 18th and before Lynchburg, the march said once; a map saved before the houses were places keeping the army at
  Bernardo and marching it straight to Harrisburg; the road going house by house, each at its marker.
...
- ~~Groce's is words, not a place.~~ Done 2026-09-17: Groce's is the army's camp west of the Brazos (`HIST-TEX-086`).
  ...
  the 14th and camps a night at Donoho's, McCarley's, the fork at Roberts' and Burnett's, places on the map, and the fork's
  question is asked at the fork. `ceiling:` the fork's left-hand road, to the Trinity at Robbins' ferry, is not on the map.
