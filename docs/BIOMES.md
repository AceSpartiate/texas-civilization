...
## 16. The bestiary checked against the record (owner, 2026-09-20)
...
### 16.2 Every animal the game uses, one at a time
...
### 16.3 What is missing, and how often the settlers mention it
...
### 16.4 What was checked and left alone
...
### 16.5 One thing for the vegetation session, not this one
