...
The later engagements of docs/BATTLES.md §5 step 3, for Fannin's command: docs/BATTLES.md §8 is what was built and where.
...
- **Engine additions** (generic, BATTLES.md §8.2), on the storming of Béxar's groups, guns, flags and staged fates: `square`,
