// The Alamo on the battle engine (docs/BATTLES.md §9; docs/battle-research/staging.md §5): the thirteen days as a living
...
test('the clock lives the siege a quarter-day a tick only for a class with somebody there, holds the assault for everybody, and never runs faster', () => {
  ...
  // Recorded for the report (docs/BATTLES.md §9.3): what the living siege adds to a class with somebody inside.
