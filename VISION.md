...
*Amended 2026-09-12 by the owner:* a student rolls a die when joining and **the roll is the family's size** — one parent for 1–3, two parents for 4–6, the rest children — so a household holds **one to six** people. *Amended again 2026-09-14:* the die has twenty sides and its face decides the family from a table the game never shows — a lone parent on 1–5, both parents on 6–20, up to eight children — so a household holds **one to ten** people. *Amended again 2026-09-22:* on the same twenty-sided die **the roll is the family's size** again — one parent and the rest children on 1–3, two parents and the rest children from 4, so a 20 is two parents and eighteen children — and a household holds **one to twenty** people, ten and a half on average, far larger than the families of the historical record (`docs/FAMILY_CREATION.md` §2). A class rolled on an earlier table keeps it. Each person also carries hidden strength, health and housework, different on average between men and women and dealt per person. See `docs/FAMILY_CREATION.md`.
