...
const FUTURE_WORK = [
  ...
  { id:'animals', scope:'Animals', delivered:'Ox/chestnut horse/cow/pig cardinal walking and four-pose grazing; white-tailed deer idle, alert, bound and drinking cycles; alternate animals have idle breathing only.', remaining:'Cream ox/grey horse/sheep/chicken locomotion, other livestock grazing and drinking, flight and load/harness behavior. Do not substitute a different coat mid-journey.' },
  { id:'artillery-service', scope:'Cannons and soldiers', delivered:'Cardinal iron gun poses, E/W iron/bronze carriage recoil, smoke, volunteer/regular aim-fire-load-ramrod and surrender, mounted marching, plus volunteer/regular ramming, roundshot carrying, lanyard and cover-ear service poses.', remaining:'Limber/unlimber, elevated aim, mounted firing and remounting. Gun recoil is whole-carriage translation, not an articulated barrel rig.' },
