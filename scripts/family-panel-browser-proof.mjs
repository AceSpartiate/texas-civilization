...
try {
  ...
  assert.equal(await page.locator('#family-panel button:not(.panel-portrait):not(.panel-icon)').count(), 0, 'the panel has a button that is not a portrait or an icon');
