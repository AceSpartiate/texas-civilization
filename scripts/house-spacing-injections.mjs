...
const cases = [
  ...
  },
  {
    ...
    file: 'sim/house-footprint.mjs', swaps: [['export const PICTURE_REACH = Object.freeze({ up: 1.6, side: 1.4, down: 0.9 });', 'export const PICTURE_REACH = Object.freeze({ up: 0, side: 0, down: 0 });']],
