...
const T = {
  ...
  fate: 'a family\'s person\'s fate falls at a discharge of the gun, visible to those watching and never before: crossing the open, down, carried under the bank',
  ...
  vFate: 'a family\'s person is drawn at their own fate: hit, then lying still and carried, or sitting hurt, or running from the field',
  vGun: 'the pack train is drawn as horses under packs, the gun is served by its own side and stays where it was taken, and the ground the map lacks is drawn',
...
const UNIT = [
  ...
  { name: 'the Grass Fight\'s question left open after the men have ridden out', file: 'sim/concepcion-grass.mjs',
    from: '  if (world.minute >= rideOut && !battle.done.closed) {', to: '  if (false) {', test: G, expect: T.gOut },
