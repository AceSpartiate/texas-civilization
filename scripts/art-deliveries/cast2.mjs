...
export const notes = [
  'This module delivered idle first. Separate delivery modules now provide work, care, search/trade, east/west walking, carrying, sowing and repair; vertical walking and dialogue remain open.',
