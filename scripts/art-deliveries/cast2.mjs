...
export const notes = [
  'This module delivered idle first. Separate delivery modules now provide work, care, search/trade, east/west walking and carrying; vertical walking, sow/repair and dialogue remain open.',
