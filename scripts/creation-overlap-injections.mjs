// The regressions `scripts/creation-screen-proof.mjs` guards, injected one at a time (CLAUDE.md: "A new test is not
...
const PROOF = 'scripts/creation-screen-proof.mjs';
const INJECTIONS = [
  {
  ...
  },
  {
    ...
    file: 'public/style.css',
    from: '#looks-parts{overflow-y:auto;min-height:0;flex:1 1 auto;padding-bottom:6px}',
    to: '#looks-parts{overflow-y:auto;min-height:0;flex:1 1 auto;padding-bottom:6px;visibility:hidden}',
