...
13. `docs/HOST_PAGE.md` before changing the Host's page while a class runs, presence, or what happens to a family whose student has gone — the class panel in words, the Rumor Mill, the spotlight and absent families becoming the director's are owner-decided (2026-09-16) and amend `VISION.md` §18.
